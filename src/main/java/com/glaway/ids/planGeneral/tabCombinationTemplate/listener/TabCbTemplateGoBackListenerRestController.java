...
/**
 * @Description: 页签组合模板驳回监听
 * @author: sunmeng
 * @ClassName: TabCbTemplateGoBackListenerRestController
 * @Date: 2019/11/29-9:40
 * @since
 */
@RestController
@RequestMapping("/feign/tabCbTemplateGoBackListenerRestController")
public class TabCbTemplateGoBackListenerRestController {
    ...
    public void notify(@RequestParam("variables") String variables)
        ...
        tabCbTemplateBusinessService.updateBizCurrentForProcessRefuse(id, flowStatus);
    }
}
