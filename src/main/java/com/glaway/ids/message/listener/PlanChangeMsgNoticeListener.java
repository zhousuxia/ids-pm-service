 ...
 * @see PlanChangeMsgNoticeListener
 * @since
 */
@Service("PlanChangeMsgNoticeListener")
public class PlanChangeMsgNoticeListener extends WSMessageProcessor {
