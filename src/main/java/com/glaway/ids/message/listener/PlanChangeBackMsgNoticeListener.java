 ...
 * @see PlanChangeBackMsgNoticeListener
 * @since
 */
@Service("PlanChangeBackMsgNoticeListener")
public class PlanChangeBackMsgNoticeListener extends WSMessageProcessor {
    ...
    public String setMessageConfigKey() {
        return "planchangeBackMsgNotice";
    }
