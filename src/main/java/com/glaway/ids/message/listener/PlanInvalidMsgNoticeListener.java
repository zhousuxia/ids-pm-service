 ...
 * @see PlanInvalidMsgNoticeListener
 * @since
 */
@Service("PlanInvalidMsgNoticeListener")
public class PlanInvalidMsgNoticeListener extends WSMessageProcessor {
...
//    }
    ...
    public List<TSUserDto> doSetReceiveUsers(JoinPoint joinPoint, Object returnValue) {
        ...
        return messageReceiverService.getMessageReceivers(MessageConstants.MESSAGE_PLAN_INVALID, planId);
    }
    ...
    public Map<String, Object> doSetVariables(JoinPoint joinPoint, Object returnValue) {
        ...
        // NoticeMsg noticeMsg = (NoticeMsg)argArray[0];
        // Map<String, Object> variables = new HashMap<String, Object>();
        // variables.put("noticeName", noticeMsg.getTitle());
        // variables.put("id", noticeMsg.getId());
        return variables;
    }
