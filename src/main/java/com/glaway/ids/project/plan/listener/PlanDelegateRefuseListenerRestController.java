 ...
 * @since
 */
@Api(tags = {"计划委派流程驳回监听接口"})
@RestController
@RequestMapping("/feign/planDelegateRefuseListenerRestController")
public class PlanDelegateRefuseListenerRestController {
    @Autowired
    ...
    public void notify(@RequestParam("variables") String variables) {
        ...
        planService.updatePlanDelegateFlag(planId);
    }
}
