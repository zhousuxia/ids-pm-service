...
@FeignClient(value = FeignConstants.ID_COMMON_SERVICE,fallback = DeliveryStandardRemoteFeignServiceCallBack.class)
public interface DeliveryStandardRemoteFeignServiceI
{
    ...
    @RequestMapping(FeignConstants.IDS_COMMON_FEIGN_SERVICE+"/feign/deliveryStandardRestController/getDeliveryStandardsByDetailNames.do")
    List<DeliveryStandardDto> getDeliveryStandardsByDetailNames(@RequestBody DeliveryStandardDto ds);
}
