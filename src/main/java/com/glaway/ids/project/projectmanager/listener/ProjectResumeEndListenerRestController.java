...
@Api(tags = {"项目恢复流程通过监听接口"})
@RestController
@RequestMapping("/feign/projectResumeEndListenerRestController")
public class ProjectResumeEndListenerRestController {
    /**
    ...
    public void notify(@RequestParam("variables") String variables) throws Exception {
        ...
        projectService.updateProjectBizCurrent(id,
                ProjectStatusConstants.PROJECT_STATUS_CHANGE_RESUME, leader);
    }
}
