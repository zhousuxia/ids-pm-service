...
@Api(tags = {"项目暂停流程通过监听接口"})
@RestController
@RequestMapping("/feign/projectPauseEndListenerRestController")
public class ProjectPauseEndListenerRestController {
    /**
    ...
    public void notify(@RequestParam("variables") String variables) {
        ...
        projectService.updateProjectBizCurrent(id,
                ProjectStatusConstants.PROJECT_STATUS_CHANGE_PAUSE, leader);
    }
}
