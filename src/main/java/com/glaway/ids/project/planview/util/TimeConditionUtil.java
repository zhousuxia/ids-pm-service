...
//            sb.append(ace[1]).append("年");
     ...
     * @see
     */
    public static String toHql(PlanViewSetCondition timeCondition, String shortName) {
        StringBuilder sb = new StringBuilder();
        ...
        if (StringUtil.isNotEmpty(timeCondition.getTimeRange())
             ...
             * for(Pair<String, String> p: timeScope)
             * {
             * sb.append(" and ").append(shortName).append(".").append("planStartTime")
             * .append(" <= ").append("to_date('").append(p.getT()).append("','yyyy-mm-dd')");
             * }
             * }
             * // 执行的计划 execPlan
             * else if (timeCondition.getShowRange().equalsIgnoreCase("execPlan")) {
             ...
             * // .append(shortName).append(".").append('planEndTime')
             * // .append(" >= ").append("to_date('").append(p.getT()).append("')")
             * // .append(" and ")
             * .append(shortName).append(".").append("planEndTime")
             * .append(" <= ").append("to_date('").append(p.getL()).append("','yyyy-mm-dd')")
             * .append(" and ")
             * .append(shortName).append(".").append("planStartTime")
             * .append(" >= ").append("to_date('").append(p.getT()).append("','yyyy-mm-dd')")
             * .append(" ) ");
             * }
             * }
             ...
             * for(Pair<String, String> p: timeScope)
             * {
             * sb.append(" and ").append(shortName).append(".").append("planEndTime")
             * .append(" <= ").append("to_date('").append(p.getL()).append("','yyyy-mm-dd')");
             * }
             * }
             */
