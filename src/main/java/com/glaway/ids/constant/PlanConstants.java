...
public class PlanConstants {
    ...
    public static final String URL_FLOWTASK_ASSIGN_VIEW = "taskFlowResolveController.do?goAssignFlowView&formId=";
    ...
    public static final String URL_FLOWTASK_CHANGE_VIEW = "taskFlowResolveController.do?goChangeFlowView&formId=";
    
//    public static final String URL_FLOWTASK_CHANGE_VIEWNEW = "rdfTaskFlowResolveController.do?goChangeFlowView&formId=";
    public static final String URL_FLOWTASK_CHANGE_VIEWNEW = "taskFlowResolveController.do?goChangeFlowView&formId=";
    public static final String URL_FLOWTASK_CHANGE_VIEWPLAN = "taskFlowResolveController.do?goChangeFlow&formId=";
    ...
    /** 子计划下达 */
    public static final String PLAN_LOGINFO_SON_ORDERED = "子计划发布";
    ...
    /** 计划待接收流程 */
    public static final String PLAN_TOBERECEIVED_PROCESS = "planReceivedProcess";
    /** 计划待接收流程 */
    public static final String PLAN_TOBERECEIVED_PROCESS_NAME = "计划待接收流程";

    /** 计划委派流程 */
    public static final String PLAN_DELEGATE_PROCESS = "planDelegateProcess";
    /** 计划委派流程 */
    public static final String PLAN_DELEGATE_PROCESS_NAME = "计划委派流程";

    /** 计划执行报表--接收 */
    public static final String PLAN_EXCUTE_REPORT_RECEIVE = "receive";
    /** 计划执行报表--驳回 */
    public static final String PLAN_EXCUTE_REPORT_TURN_DOWN = "turnDown";
    /** 计划执行报表--委派 */
    public static final String PLAN_EXCUTE_REPORT_DELEGATE = "delegate";
}
